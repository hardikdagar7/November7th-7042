[November7th-7042] Operating Details
====================================

Generated On: 2024-11-07 21:25:37 UTC
...
.. important::
   ...
   **not be valid if your [November7th-7042] container is NOT running**.

.. tip::
   You must have your [November7th-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41885  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/November7th-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/November7th-7042-amd64)
...
.. important::
   docker run -d -p 59283:59283 -p 48235:48235 -p 53669:53669 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=November7th-7042 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-November7th-7042 \-\-env GITUSERNAME=hardikdagar7  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=59283  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=48235  \-\-env SOLUTIONVIPERVIZPORT=53669 \-\-env DOCKERUSERNAME='hardikdagar0207' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=41885 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hardikdagar0207' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hardikdagar0207/November7th-7042-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=53669
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=59283
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hardikdagar0207/November7th-7042-amd64
...
It can be accessed by entering: http://localhost:48235
...
.. important::
   http://localhost:53669/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:53669/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:53669/<html file>
...
[November7th-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/November7th-7042
...
.. important::
   https://November7th-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-November7th-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59283, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=32941, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36641, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36987, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38473, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33853, HPDEHOST=127.0.1.1, HPDEPORT=41509, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38215

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2344-November7th-7042,solution_preprocessing_ai_mqtt_dag-November7th-7042, python-preprocess-1826-November7th-7042,solution_preprocessing_ai_mqtt_dag-November7th-7042, python-ai-746-November7th-7042,solution_preprocessing_ai_mqtt_dag-November7th-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
